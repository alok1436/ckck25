            ...
            <div class="d-none d-sm-block">
                ...
                <form class="app-search d-none d-lg-block">
                    <div class="position-relative" style="width:300px;">
                        <input type="text" class="form-control" placeholder="Search Name/Number/Mail ...">
        ...
        <div class="d-flex">
                    ...
                    <form class="p-3">
                        <div class="form-group m-0">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Search Name/Number/Mail ..." aria-label="Name/Number/Mail">
            ...
            <div class="dropdown d-inline-block pt-1 mt-1">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="page-header-user-dropdown">
                    ...
                    <a class="dropdown-item text-danger" href="{{ url('admin/logout')}}"><i class="mdi mdi-power font-size-17 text-muted align-middle me-1 text-danger"></i> Logout</a>
                </div>
            </div>
